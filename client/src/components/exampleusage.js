...
function ExampleUsage(){
    return(
        <div id="exampleusage" className="container">
            ...
            <p>&nbsp;&nbsp;&nbsp;&nbsp;You may enter any of the following formats into the above input or attached to the url above<br></br> &nbsp;&nbsp;&nbsp;&nbsp;(e.g. server-url/api/&lt;timestamp&gt; where &lt;timestamp&gt; is replaced by your timestamp.)</p>
